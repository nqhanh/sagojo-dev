	...
	if($groups) {
		...
		foreach($groups as $group) {
			...
			if($group->modus == 2) {
				...
				$output .= ".b-".$group->id." li { float:left; padding:0; margin:".$group->admargin."px; height:".$adheight."; width:".$adwidth."; list-style:none; }\n";
				$output .= ".b-".$group->id." li:hover { -webkit-box-shadow: 0 0 0.3em hsla(0, 0%, 0%, 1.0);
													-moz-box-shadow: 0 0 0.3em hsla(0, 0%, 0%, 1.0);
													box-shadow: 0 0 0.3em hsla(0, 0%, 0%, 1.0);}\n";
