...
class LazyestFields {
  ...
  function settings_main() {
    global $lg_gallery;
    ?>
    <div id="lg_extra_field_options">
      <h3><?php esc_html_e( 'Extra Fields', 'lazyest-gallery' ) ?></h3>
      <p><?php esc_html_e( 'Enter your own fields to be stored along with your Folders or Images.', 'lazyest-gallery' ); ?></p>
      <table id="lg_extra_fields_table" class="form-tble">
        <thead>
          <tr>
