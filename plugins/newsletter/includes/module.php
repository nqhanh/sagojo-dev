...
//    }
    ...
    function add_menu_page($page, $title) {
        ...
        add_submenu_page('newsletter_main_index', $title, $title, ($newsletter->options['editor'] == 1) ? 'edit_posts' : 'manage_options', $name, $name);
    }
    ...
    function add_admin_page($page, $title) {
        ...
        $name = 'newsletter_' . $this->module . '_' . $page;
        eval('function ' . $name . '(){global $newsletter, $wpdb;require \'' . $file . '\';}');
        add_submenu_page(null, $title, $title, ($newsletter->options['editor'] == 1) ? 'edit_posts' : 'manage_options', $name, $name);
    }
