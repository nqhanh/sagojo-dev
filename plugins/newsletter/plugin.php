...
/*
  Plugin Name: Sagojo Email
  Plugin URI: http://www.sagojo.com
  Description: Newsletter is a cool plugin to create your own subscriber list, to send newsletters, to build your business. 	  Version: 1.0
  Author: Sagojo 
  Author URI: http://www.sagojo.com
  Disclaimer: Use at your own risk. No warranty expressed or implied is provided.

  Copyright 2013 sagojo.com (http://www.sagojo.com)
 */
...
class Newsletter extends NewsletterModule {
    ...
    function admin_menu() {
        ...
        add_menu_page('Sagojo Email', 'Sagojo Email', ($this->options['editor'] == 1) ? 'edit_posts' : 'manage_options', 'newsletter_main_index');
