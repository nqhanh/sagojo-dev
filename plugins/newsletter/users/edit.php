...
?>
<div class="wrap">
    <?php $help_url = 'http://www.sagojo.come'; ?>
  ...
  <form method="post" action="">
    ...
    <div id="tabs">
      ...
      <ul>
        ...
        <li><a href="#tabs-2" style='display:none;'>Preferences</a></li>
        <li><a href="#tabs-3" style='display:none;'>Profile</a></li>
      ...
      <div id="tabs-1">
        ...
        <table class="form-table">
          ...
          <tr valign="top">
            <th>Customer</th>
            <td>
              <?php $controls->select('sex', array('n' => 'Partner', 'e' => 'Employee', 'j' => 'Jobseeker')); ?>
            </td>
          </tr>
          <tr valign="top">
            <th>Status</th>
