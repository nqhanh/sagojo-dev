			...
			<div class="resume-container">
				<div class="resume-inner">
					...
					<?php if ($tagline): ?>
							...
							<?php endif; ?>
					</div><div style="clear:both;margin-bottom:50px;"></div>
						<div class="col-sm-3">
							<?php //the_post_thumbnail(array(400,400), array('class'=>'resume-avatar'));?>
							<img src="<?php echo $image;?>">
						</div>
						
						<div class="col-sm-9 resume-bio"><div class="rs_comment_text"><?php
							if (!$hide_objective) { ?>
							<!-- start objective -->
						...
						?>
							<ul class="resume-bio-meta">
								...
								<?php if ($email): ?>
									<div class="col-sm-6"><li><a href="mailto:<?php echo $email;?>" class="resume-bio-email"><i class="resumecon resumecon-envelope"></i> <?php echo $email;?></a></li>
								<?php endif;
								if ($website): ?>
								...
								<?php endif;
								if ($phone): ?>
									<li><i class="resumecon resumecon-phone-square"></i> <?php echo $phone;?></li></div><div class="col-sm-5">
								<?php endif; 
								if ($my_location): ?>
					...
					<main class="resume-section-main">
						...
						if (!$hide_experience) { ?>
							...
							<section class="content-row row resume-work-wrap">
							<div class="border-virtual"></div><div class="tag-rs">
								<div class="rs-title">
						...
						if (!$hide_skills) { ?>
							<!-- start skillset wrap -->
							<section class="content-row row resume-skillset-wrap">
							<div class="border-virtual"></div><div class="tag-rs">
								<div class="rs-title">
						...
						if (!$hide_education) { ?>
							...
							<section class="content-row row resume-education-wrap">
							<div class="border-virtual"></div><div class="tag-rs">
								<div class="rs-title">
						...
						if (!$hide_github) { ?>
							...
							<section class="content-row row resume-github-wrap no-print">
							<div class="border-virtual"></div><div class="tag-rs">
								<div class="rs-title">
									<h4 class="zmt resume-item-title"></i><?php echo $github_title;?></h4>
								</div>
							</div><div style="clear:both;"></div>
						...
						if (!$hide_portfolio) { ?>
							<!-- start portfolio -->
							<section class="content-row row resume-portfolio-wrap no-print">
							<div class="border-virtual"></div><div class="tag-rs">
								<div class="rs-title">
