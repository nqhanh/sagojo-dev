					...
					<table class="form-table">
						<tbody>
							...
							<tr>
								...
								<td><label><input type="checkbox" name="allowfeed" value="<?php echo $allowfeed;?>" /> <strong><?php _e('Enable','seo-auto-links'); ?></strong></label><br/><span class="description"><?php _e('Allow processing of RSS feeds. SEO Auto links will embed links in all posts in your RSS feed (according to other options).','seo-auto-links'); ?></span></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><label><input type="checkbox" name="casesens" value="<?php echo $casesens;?>" /> <strong><?php _e('Enable','seo-auto-links'); ?></strong></label><br/><span class="description"><?php _e('Set whether matching should be case sensitive.','seo-auto-links'); ?></span></td>
							</tr>
						</tbody>
					</table>
					...
					<table class="form-table">
						<tbody>
							...
							<tr>
								...
								<td><label><input type="checkbox" name="nofolo" value="<?php echo $nofolo;?>" /> <strong><?php _e('Enable','seo-auto-links'); ?></strong></label><br/><span class="description"><?php _e('Add a nofollow attribute to the external links.','seo-auto-links'); ?></span></td>
							</tr>
							<tr>
								<th><?php _e('Open in new window','seo-auto-links'); ?>:</th>
								<td><label><input type="checkbox" name="blanko" value="<?php echo $blanko;?>" /> <strong><?php _e('Enable','seo-auto-links'); ?></strong></label><br/><span class="description"><?php _e('Open the external links in a new window.','seo-auto-links'); ?></span></td>
							</tr>
						</tbody>
					</table>
