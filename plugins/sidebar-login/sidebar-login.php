...
class Sidebar_Login {
	...
	public function enqueue() {
		...
		$sidebar_login_params = array(
			...
			'is_ssl'           => is_ssl() ? 1 : 0,
			'i18n_username_required' => __( '[:en]Please enter your username[:vi]Vui lòng điền tên người dùng[:ja]ユーザ名を入力して下さい。', 'sidebar_login' ),
			'i18n_password_required' => __( '[:en]Please enter your password[:vi]Vui lòng điền mật khẩu.[:ja]Please enter your password', 'sidebar_login' ),
	...
	public function ajax_handler() {
		...
		if ( ! is_wp_error($user) ) {
			...
			if ( $user->errors ) {
				...
				$result['error'] = __( '[:en]Please enter your username and password to login.[:vi]Vui lòng nhập tên tài khoản và mật khẩu.', 'sidebar_login' );
			}
		}
