...
* Bug Fix - additional URL parameters were broken for Tumblr.
* Bug Fix - Stumbleupon incorrect bad user/pass problem for some accounts.
* Bug Fix - Stumbleupon unnecessary debug info removed.
...
* Bug Fix - StumbleUpon NSFW checkbox wasn't working from the "Edit post" page. 

= 2.7.15 [06/12/2013] =

* Bug Fix - Some Twitter functionality were not working because of Twitter V1 API retirement on June 11, 2013. 
