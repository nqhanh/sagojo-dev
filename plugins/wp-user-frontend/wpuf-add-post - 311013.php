                    ...
                    <ul class="wpuf-post-form">
                        ...
                        if ( wpuf_get_option( 'allow_tags', 'wpuf_frontend_posting', 'on' ) == 'on' ) {
                            ...
                            /*Tag suggest by Hanh*/								
                            	...
                            	?>
                                    <link href="<?php echo site_url()?>/wp-content/themes/responsive/css/jquery.tagit.css" rel="stylesheet" type="text/css">
                                    <link href="<?php echo site_url()?>/wp-content/themes/responsive/css/tagit.ui-zendesk.css" rel="stylesheet" type="text/css">
                                    ...
                                    <!-- The real deal -->
                                    <script src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.js" type="text/javascript" charset="utf-8"></script>
                                    
                                    <script src="<?php echo site_url()?>/wp-content/themes/responsive/js/tag-it.js" type="text/javascript" charset="utf-8"></script>
                                
                                    <script>
                                        $(function(){
                                        	
                                            var sampleTags = [<?php echo $array_tags; ?>];
                            ...
                            <form>
                            <?php _e('Enter some skills that relate to the project:', 'wpuf' );?>
                            <input type="hidden" name="wpuf_post_tags" id="mySingleField"> <!-- only disabled for demonstration purposes -->
