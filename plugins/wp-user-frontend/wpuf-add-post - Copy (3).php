                ...
                <form id="wpuf_new_post_form" name="wpuf_new_post_form" action="" enctype="multipart/form-data" method="POST">
                    ...
                    <ul class="wpuf-post-form">
                        ...
                        if ( wpuf_get_option( 'allow_tags', 'wpuf_frontend_posting', 'on' ) == 'on' ) {
                            ...
                            /*Tag suggest by Hanh*/
							?><link rel="stylesheet" href="<?php echo site_url()?>/wp-content/themes/responsive/js/chosen.css">
							<link rel="stylesheet" href="<?php echo site_url()?>/wp-content/themes/responsive/js/docsupport/prism.css">
							 
							  <?php _e('Enter some skills that relate to the project:', 'wpuf' );?>							  							  
							<select name="wpuf_post_tags" data-placeholder="input some skills..." class="chosen-select" multiple style="width:350px;" tabindex="4"> 
                              		<option value=""></option>
									<?php 
									$tags = get_freelance_tags();
									$html = "";
									foreach ( $tags as $tag ) {
                             ...
                             ?>                                  
                             <script src="<?php echo site_url()?>/wp-content/themes/responsive/js/chosen.jquery.js" type="text/javascript"></script>
							  <script src="<?php echo site_url()?>/wp-content/themes/responsive/js/docsupport/prism.js" type="text/javascript" charset="utf-8"></script>
							  <script type="text/javascript">
