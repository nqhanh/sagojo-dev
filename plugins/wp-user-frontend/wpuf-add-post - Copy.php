                ...
                <form id="wpuf_new_post_form" name="wpuf_new_post_form" action="" enctype="multipart/form-data" method="POST">
                    ...
                    <ul class="wpuf-post-form">
                            ...
                            <li>
                                ...
                                <span class="category-wrap" style="float:left;">
                                    <span id="lvl0">
                                        ...
                                        if ( $cat_type == 'normal' ) {
											wp_dropdown_freelance_category('show_count=0&selected=-1&hierarchical=1&depth=1&hide_empty=0&class=cat requiredField&exclude=1&show_option_none=' . __( '-- Select one --', 'wpuf' ) . '&name=main_cat');
                                        ...
                                        ?>
                                        <select name="category" id="category" disabled="disabled" class="requiredField"></select>
                        ...
                        if ( wpuf_get_option( 'allow_tags', 'wpuf_frontend_posting', 'on' ) == 'on' ) {
                            ...
                            <input type="text" name="wpuf_post_tags" id="mySingleField"  disabled="true" type="hidden"> <!-- only disabled for demonstration purposes -->
                           ...
                           /*$tags = get_freelance_tags();
									...
									foreach ( $tags as $tag ) {
										...
										$html .= "<input type='checkbox' name='most_post_tags[]' value='$tag->name'>&nbsp;$tag->name&nbsp;&nbsp;";
									}
									$html .= '</div>';
									echo "<li><label for=\"new-post-tags\">";
                                    echo "Most used tags";
                                	echo "</label>";
									echo $html;
									echo "</li>";*/
