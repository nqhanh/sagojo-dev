                ...
                <tbody>
                    ...
                    while ($dashboard_query->have_posts()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ( $charging_enabled == 'yes' ) { wpuf_show_post_status( $post->post_status );}
                                else{
            ...
            <div class="wpuf-author">
                ...
                <div class="wpuf-author-inside odd">
                    ...
                    <div class="wpuf-author-body">
                        <p class="wpuf-user-name"><a href="<?php echo get_author_posts_url( $userdata->ID ); ?>"><?php printf( esc_attr__( '%s', 'wpuf' ), $userdata->display_name ); ?></a><br />
						<?php printf( esc_attr__( '%s', 'wpuf' ), $userdata->user_email ); ?></p>
