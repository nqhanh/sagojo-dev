...
class Wpjb_Module_Frontend_AddJob extends Wpjb_Controller_Frontend
{
    ...
    public function addAction()
    {
        ...
        if($request->session("wpjb.reset_job", false)) {
			...
			$arr['job_address'] = $emp->company_address;
    ...
    public function previewAction()
    {
        ...
        $accept = array("company_name", "company_email", "company_website",
            ...
            "job_location", "job_title", "job_description", "job_required", "job_interest", "contact_description", "job_contact",
			"job_phone","job_address", "job_salary"
        );
    ...
    public function saveAction()
    {
        ...
        if($action == "payment_form") {
            $payment = new Wpjb_Payment_PayPal($job->getPayment(true));
