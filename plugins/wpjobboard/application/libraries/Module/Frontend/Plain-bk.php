...
class Wpjb_Module_Frontend_Plain extends Wpjb_Controller_Frontend
{
    ...
    protected function _feed($result) //TODO: hrtrhau
    {
        ...
        foreach($result as $job) {
            ...
            $desc="<pre><strong>".mb_convert_case($this->_esc($job->job_title),MB_CASE_UPPER, "UTF-8")."</strong>\n <br /><br />";
           
            $desc.="<strong>=== Tên công ty:</strong> ".$job->company_name."\n <br /><br />";

            $desc.="<strong>=== Nơi làm việc:</strong> ".$job->job_address."\n <br /><br />";

            $desc.="<strong>=== Mức lương</strong>: Thỏa thuận"."\n <br /><br />";
