...
class Wpjb_Widget_JobNumber extends Daq_Widget_Abstract
{
    public function __construct() 
    {
        $this->_context = Wpjb_Project::getInstance();
        $this->_viewAdmin = "job-number.php";
        $this->_viewFront = "job-number.php";
        
        parent::__construct(
            "wpjb-job-number", 
            __("Job Number", WPJB_DOMAIN),
            array("description"=>__("Displays number of job posted", WPJB_DOMAIN))
        );
    }
