...
class Jobseeker  {
	...
	private $SalaryPreference;			// User's Salary Preference
	...
	*/
	...
	/**
	 * getSalaryPreference
	 * @return	The Salary Preference.
	 */
	public function getSalaryPreference(){
		return $this->SalaryPreference;
	}
	
	/**
	 * setSalaryPreference
	 * @param	salary	jobseeker's salary preference.
	 * @return	void.
	 * @access	Store salary that jobseeker want to.
	 */
	public function setSalaryPreference($salary){
		$this->SalaryPreference=$salary;
	}
