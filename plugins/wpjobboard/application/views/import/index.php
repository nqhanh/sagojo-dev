...
<div class="wpjb-buttons" style="float:left">
    <div class="import-wrap">
        <a href="<?php echo $this->_url->linkTo("wpjb/import", "xml"); ?>" style="font-size:40px;text-decoration:none;font-weight: bold">Import Jobs</a>
        <br/><br/>
...
<div class="wpjb-buttons" style="float:left">
    <div class="import-wrap">
        <a href="<?php echo $this->_url->linkTo("wpjb/import", "cvitae"); ?>" style="font-size:40px;text-decoration:none;font-weight: bold">Import CVs</a>
        <br/><br/>
        <a href="<?php echo $this->_url->linkTo("wpjb/import", "cvitae"); ?>"class="button button-highlighted">
            <?php _e("Import CVitaes ...", WPJB_DOMAIN) ?>
        </a>
    </div>
    <div class="import-desc">
        <p><b><?php _e("Import from your own XML file", WPJB_DOMAIN) ?></b></p>
        <p><?php _e("This is the best option for users who wish to Import CVs from their database. ", WPJB_DOMAIN) ?></p>
    </div>
