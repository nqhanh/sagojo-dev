...
<table cellspacing="0" class="widefat post fixed">
    ...
    <<?php echo $tx; ?>>
        <tr>
			...
			<th style="" class="" scope="col"><?php _e("F-Visible", WPJB_DOMAIN) ?></th>
	...
	<tr valign="top" class="<?php if($i%2==0): ?>alternate <?php endif; ?>  author-self status-publish iedit">
			...
			<td class="categories column-categories"><?php echo ($item->f_visible==0) ? __("<i>always</i>", WPJB_DOMAIN) : ($item->f_visible." ".__("days", WPJB_DOMAIN)) ?></td>
