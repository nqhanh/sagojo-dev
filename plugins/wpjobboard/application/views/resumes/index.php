...
<ul class="subsubsub">
	...
	<li><a <?php if($show == "active"): ?>class="current"<?php endif; ?> href="<?php echo $this->_url->linkTo("wpjb/resumes", "index/show/active/".$qstring) ?>"><?php _e("Active", WPJB_DOMAIN) ?></a><span class="count">(<?php echo (int)$stat->active ?>)</span> | </li>
...
<table cellspacing="0" class="widefat post fixed">
	...
	<tr valign="top" class="<?php if($i%2==0): ?>alternate <?php endif; ?>  author-self status-publish iedit">
            ...
            <td class="date column-date"><?php echo strtotime($item->updated_at)<=0 ? "-" : daq_time_ago_in_words(strtotime($item->updated_at))." ago" ?></td>
