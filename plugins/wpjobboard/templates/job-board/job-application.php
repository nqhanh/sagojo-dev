                ...
                <td>
                    ...
                    function newPopup(url) {
                    	popupWindow = window.open(
                    		url,'popUpWindow','height=600,width=700,left=50,top=10,resizable=no,scrollbars=yes,toolbar=no,menubar=no,location=no,directories=no,status=yes')
                            if (window.focus) {newwindow.focus()}
                    	       return false;
                    }
                    </script>
                    <a id="ungvien-jb-jb-app" href="JavaScript:newPopup('<?php echo esc_attr($file->url); ?>');"><?php echo esc_html($file->basename) ?></a>
