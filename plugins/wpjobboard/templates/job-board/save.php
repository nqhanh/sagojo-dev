        ...
        <table class="wpjb-info" id="wpjb-payment">
            <tbody>
				...
				<tr class="wpjb-no-border">
                    ...
                    <td colspan='2'><?php _e("Thank you for posting.", WPJB_DOMAIN) ?></td>
                </tr>
				<tr class="wpjb-no-border">
                   
                    <td colspan='2'><?php _e("You will receive a confirmation email from us momentarily with payment information for your order. This job will be actived after successfully completed payment.", WPJB_DOMAIN) ?></td>
                </tr>
            </tbody>
        </table>
