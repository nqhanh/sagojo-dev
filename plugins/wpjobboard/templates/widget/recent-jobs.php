...
<blockquote>
<?php _e("Choose a job you love and you will never have to work a day in your life", WPJB_DOMAIN);?>
<cite><?php _e("Confucius", WPJB_DOMAIN);?></cite>
</blockquote>
