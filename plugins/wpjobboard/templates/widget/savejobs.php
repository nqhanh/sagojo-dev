...
<ul id="taber-wpjb-recently-viewed">
    <?php if(!empty($saved)): foreach($saved as $job): ?>
    <li>
    ...
    <?php 	
	endforeach; ?>
	<li style="list-style-type:none;float:right;"><a href="<?php echo site_url()?>/my-jobs/"><?php _e("see more...", WPJB_DOMAIN)?></a></li>
    <?php else: ?>
    <li><?php _e("You have no any saved job.", WPJB_DOMAIN) ?></li>
    <?php endif; ?>
</ul>
