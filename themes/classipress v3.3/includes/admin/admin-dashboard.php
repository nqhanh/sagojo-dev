...
class CP_Theme_Dashboard extends APP_DashBoard {
	...
	public function __construct() {
		...
		parent::__construct( array(
			'page_title' => __( 'ClassiPress Dashboard', APP_TD ),
...
<?php
		...
		if ( isset( $listings['publish'] ) ) {
			$stats[ __( 'Total Live Ads', APP_TD ) ] = array(
		...
		if ( isset( $listings['pending'] ) ) {
			$stats[ __( 'Total Pending Ads', APP_TD ) ] = array(
		...
		$stats[ __( 'Total Users', APP_TD ) ] = array(
		...
		$stats[ __( 'Product Version', APP_TD ) ] = $app_version;
