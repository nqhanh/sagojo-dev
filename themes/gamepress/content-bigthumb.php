			...
			<?php 
				...
				<div class="img-wrapper">
					<a href="<?php the_permalink(); ?>" rel="bookmark" class="img-bevel" title="<?php the_title(); ?>"><?php the_post_thumbnail('nivo-slide'); ?></a>
			<?php
				} else { ?>
				<div class="noimage">
			<?php } ?>
				...
				<div class="entry-content">
					<p>
						<?php gamepress_excerpt('gamepress_excerptlength_default', 'gamepress_excerptmore'); ?>
					</p>
				</div>
			</article>
