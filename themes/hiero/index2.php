			...
			<div id="primary" class="content-area">
				...
				<div id="content" class="site-content" role="main">
					...
					<div <?php post_class(); ?>>
						...
						<div class="title"><h2 style="font-size:18px; margin: 8px 0px;"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2></div>
						<?php if ( has_post_thumbnail() ) : ?>
						<div class="entry-thumbnail" style="float: left; margin-right: 10px;" >
							<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" >
								<?php the_post_thumbnail( array(250,175) ); ?>
							</a>
						</div>
						<?php endif; ?>
