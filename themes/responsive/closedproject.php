 ...
 *
 * @file           closedproject.php
 * @package        Responsive 
 * @author         sagojo.com 
 * @copyright      2003 - 2011 ThemeID
 * @license        license.txt
 * @version        Release: 1.0
 * @filesource     wp-content/themes/responsive/closedproject.php
...
<div class="nav">
	<ul>
		...
		<li class="current"><a href="<?php echo site_url()?>/closed-projects/"><?php _e('Closed Projects','responsive');?></a></li>
