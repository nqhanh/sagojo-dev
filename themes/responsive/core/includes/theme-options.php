        ...
        <form method="post" action="options.php">
            ...
            <div class="rwd-container">
				...
				<div class="grid col-300">
							<label for="responsive_theme_options[show_carousel]"><?php _e('Enable Carousel', 'max-magazine'); ?></label>
							<input id="responsive_theme_options[show_carousel]" name="responsive_theme_options[show_carousel]" type="checkbox" value="1" <?php isset($options['show_carousel']) ? checked( '1', $options['show_carousel'] ) : checked('0', '1'); ?> />
							<span><?php _e( 'Check to enable the carousel on homepage.', 'max-magazine' ); ?></span>					
						</div>
	
						<div class="grid col-620 fit">														
							<label for="responsive_theme_options[carousel_category]"><?php _e('Carousel Category', 'max-magazine'); ?></label>
							<?php 
							$categories = get_categories( array( 'hide_empty' => 1, 'hierarchical' => 0 ) );  ?>
							<select id="carousel_category" name="responsive_theme_options[carousel_category]">
