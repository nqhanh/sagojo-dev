 ...
 *
   Template Name: IsBIG IsSmall
 *
 * @file           isbig_issmall.php
 * @package        Responsive 
 * @author         Emil Uzelac 
 * @copyright      2003 - 2011 ThemeID
 * @license        license.txt
 * @version        Release: 1.0
 * @filesource     wp-content/themes/responsive/isbig_issmall.php
...
<div class="nav">
	<ul>
		<?php if ($user_id > 0):?><li class="current"><a href="<?php echo site_url()?>/jobs/"><?php _e('Post Project','responsive');?></a></li>
		<?php endif;?>
