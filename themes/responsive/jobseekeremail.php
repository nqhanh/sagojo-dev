 ...
 *
   Template Name:  Jobseeker Emails
 *
 * @file           jobseekeremail.php
 * @package        Responsive 
 * @author         Emil Uzelac 
 * @copyright      2003 - 2011 ThemeID
 * @license        license.txt
 * @version        Release: 1.0
 * @filesource     wp-content/themes/responsive/jobseekeremail.php
...
<?php get_template_part( 'loop-header' ); ?>
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>       
				<h1 class="entry-title-coupon post-title-coupon">
					Sending email to jobseekers
				</h1>
                
                <div class="post-entry">
                   <?php maketing_mails( 'is_employer', '1');//loai tru nha tuyen dung - chi gui mail cho jobseeker?>
				   <?php /*maketing_mails( 'is_employer', '0');*/ //gui mail cho nha tuyen dung?>
					<p>
