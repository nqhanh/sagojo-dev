  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage	: location.protocol + '//' + location.hostname+'/wordpress_op2/wp-content/themes/responsive/images/bramus/percentImage.png',			// boxImage : image around the progress bar
			barImage	: location.protocol + '//' + location.hostname+'/wordpress_op2/wp-content/themes/responsive/images/bramus/percentImage_back.png',	// Image to use in the progressbar. Can be an array of images too.
			 ...
			 */
				setPercentage		: function(el, percentage, clearQueue) {
					this.pbArray[el].setPercentage(percentage, clearQueue);	
						var a = parseInt(document.getElementById("Mytextbox"+el).value);
						a += parseInt(percentage);
						if (a > 100){
							a = 100;
						}
						if (a < 0){
						...
						document.getElementById("Mytextbox"+el).value = a;
				},
