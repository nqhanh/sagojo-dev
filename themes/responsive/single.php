...
if (in_category( array('cam-nang-viec-lam','huong-dan-viet-cv','mau-cv-tim-viec','phong-van-viec-lam'))){include (TEMPLATEPATH . '/single-cnvl.php');
}
else 
{
	get_header(); 
		...
		<?php while (have_posts()) : the_post(); ?>
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>   
                ...
                <div class="post-entry" style="text-align: justify;">
						...
						echo "<div class='blog-author-info-content'><div class='blog-display_name vcard author'><span class='fn'>".the_author_posts_link()."</span></div>";
						echo "<div class='blog-text'><div class='blog-cat-date-post'>".the_date('dd-mm-yyyy')."</div>";
						echo "<div class='blog-cat-title date updated'>".the_time()." - ".$user_url."</div></div></div>";
						echo "</div>";
						?>
			...
			<h1 id="relate-single"><?php _e('[:en]Related posts:[:vi]Bài cùng chuyên mục:', 'responsive');?></h1>
